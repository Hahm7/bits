...
function makeDark(){
    ...
    bodyElement.style.setProperty('--background-color', "rgba(34, 39, 46)");
    bodyElement.style.setProperty('--accent', "#E9DAAC");
    bodyElement.style.setProperty('--hover', "rgba(255, 255, 255, 0.07)");
    bodyElement.style.setProperty('--gradient', "linear-gradient(180deg, rgba(34, 39, 46) 0%, rgba(66, 81, 98, 0.36) 100%)");
